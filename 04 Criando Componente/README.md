# 🧩 Módulo 4: Arquitetura de Componentes
...
Transição de interfaces monolíticas para _Atomic Design_. Modularização do código através da criação de componentes customizados, estabelecendo regras estritas de exportação/importação e separação entre a lógica (`index.js`) e a interface (`estilos.js`).

## 📁 Projetos Desenvolvidos

- CriacaoComponente
- Componente-import-export
- Componente-padroes-arquivo
- Componente-topo-conteudo
- Componente-topo-conteudo-estilo
- Componente-topo-conteudo-estilo-separando
