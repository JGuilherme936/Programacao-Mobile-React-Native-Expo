# 🔄 Módulo 10: Reatividade e Hooks (useState)
...
Desacoplamento de variáveis estáticas em favor do estado mutável. Uso do hook funcional `useState` para engatilhar re-renderizações automáticas no Virtual DOM sempre que o usuário interage com a tela.

## 📁 Projetos Desenvolvidos

- aula10-variaveis-estado
